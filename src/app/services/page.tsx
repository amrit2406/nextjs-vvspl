...
const SOFTWARE_SOLUTIONS: ServiceItem[] = [
  {
    slug: "edtech",
    title: "Edu tech",
    desc: "Scalable digital learning platforms, LMS systems, and AI-powered education tools built to enhance engagement and learning outcomes.",
  ...
  },
  {
    slug: "erp",
    title: "ERP Systems",
    desc: "Unified enterprise platforms to manage finance, inventory, operations, and reporting with real-time data visibility.",
  ...
  },
  {
    slug: "crm",
    title: "CRM",
    desc: "Smart customer relationship systems to track leads, automate sales workflows, and improve customer retention.",
  ...
  },
  {
    slug: "ui-ux-design",
    title: "UI/UX Design",
    desc: "Intuitive and user-focused interface designs that improve usability, engagement, and overall digital experience.",
  ...
  },
  {
    ...
    desc: "Automation solutions to streamline internal operations, reduce manual work, and improve efficiency across business processes.",
...
const CONSULTING_SERVICES: ServiceItem[] = [
  {
    ...
    desc: "Performance-driven marketing strategies including SEO, paid campaigns, and content to increase visibility, traffic, and conversions.",
  ...
  },
  {
    slug: "it-staffing",
    title: "IT Staffing",
    desc: "Skilled and vetted tech professionals to support your projects, scale your team, and accelerate development timelines.",
